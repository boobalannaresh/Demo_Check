...
//     if (error) console.error('Error adding Item Master:', error.message);
//     else {
...
//       const { error } = await supabase
//         .from('item_master')
//         .update({ itemname: newItemMasterName, noofitemsinbox: newNoofItemsinBox, itemweight: newItemWeight, rrprice: newItemRRPrice, lastupdatetime: new Date().toISOString(),segmentname: newSegmentName,})
//         .eq('itemid', currentItemMaster.itemid);

//       if (error) console.error('Error editing items:', error.message);
//       else {
//         setNewItemMasterName('');
//         setNewNoofItemsinBox('');
//         setNewItemWeight('');
...
//                 <td><center>{itemMaster.segmentname.trim()}</center></td>
//                 <td><center>{itemMaster.categoryname.trim()}</center></td>
...
//                 <option key={segment.segmentid} value={segment.segmentname}>
//                   {segment.segmentname}
//                 </option>
//               ))}
//             </select>
